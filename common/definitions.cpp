...
void init_cfg() {
  ...
  CFG_SET_ENTRY("rollback",         CFG.rollback,         false           )
  CFG_SET_ENTRY("rblimit",          CFG.rblimit,          2               )
  CFG_SET_ENTRY("ignoreslice",      CFG.ignoreslice,      true            )
  CFG_SET_ENTRY("findallcolors",    CFG.findallcolors,    false           ) // useless
  CFG_SET_ENTRY("findallcongruent", CFG.findallcongruent, false           ) // useless
  CFG_SET_ENTRY("verify",           CFG.verify,           true            ) // useless
